...
project = 'Firstyear\'s blog-a-log'

# Change this to the tagline of your blog
tagline = 'Adventures of a professional nerd.'

# Change this to the description of your blog
description = 'Firstyear`s blog-a-log'
...
website = 'https://fy.blackhats.net.au/blog/html/'
...
html_sidebars = {
    '**': ['recent.html', 'searchbox.html', 'rss.html']
}
