...
Again we can see the DN, the objectclasses, and the cn, which is our
...
If we were to want to retrieve *only* the HR Managers group, but we
...
[PART 3, filters!](ldap_guide_part_3_filters.html)
